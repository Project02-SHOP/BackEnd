...
public class ProductEntity {
    ...
    @Column(name = "sale_end_date")//sale_end_date로 바꿔야할 듯. -> 바꿈(소정)
    ...
    public static ProductEntity fromDto(ProductDTO product) {
        return ProductEntity.builder()
                ...
                .categoryId(product.getCategoryId() != null ? CategoryEntity.builder().categoryId(product.getCategoryId()).build() : null)
